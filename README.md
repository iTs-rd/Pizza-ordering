## PIZZA DELIVERY API
This is a REST API for a Pizza delivery service built for fun and learning with Django REST framework and JSON Web Token(JWT).
<br>
<br>
...
| ------- | ----- | ------------- | ------------- |
| *POST* | ```/api/signup/``` | _Register new user_| _open for all_|
...
| *GET* | ```/orders/``` | _Get all your orders_|_All users_|
